...
# ------------------------------------------------------------------------------
#export IBM_ENTITLEMENT_KEY=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJJQk0gTWFya2V0cGxhY2UiLCJpYXQiOjE2OTYzNTAzNjQsImp0aSI6IjFmZjcyYmExMzU3NzQzMTFiMGI4YTdjNWU3MDQwYmViIn0.vxK0jmaP7FEv_HeEZ_zLfU0IERFRgnkOWYy9LyMFGwk
...
export COMPONENTS=ibm-cert-manager,ibm-licensing,scheduler,cpfs,cpd_platform,cognos_analytics,wkc,db2wh,datastage_ent_plus 
